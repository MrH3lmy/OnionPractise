...
{
    public class GetLeaveAllocationListRequestHandler : IRequestHandler<GetLeaveAllocationDetailRequest, List<LeaveAllocationDto>>
    {
        ...
        {
            var leaveAllocation = await _alloctionRepository.GetAll();
